...
const description = 'Configure the outer ring of the three corner finder patterns. Full API reference for the finderPatternOuterSettings prop.'
usePageSeo('FinderPatternOuterSettings', description)
defineOgImage('DocsCover', { title: 'FinderPatternOuterSettings', description })
const styles = [
...
<template>
  <div class="prose">
    ...
    <DocsPropsTable
      :rows="[
        { name: 'style', type: 'FinderPatternOuterStyle', default: '\'square\'', description: 'Shape of the outer finder pattern ring.' },
...
/>`" />
    ...
    <DocsCodeBlock lang="ts" :code="`type FinderPatternOuterStyle =
