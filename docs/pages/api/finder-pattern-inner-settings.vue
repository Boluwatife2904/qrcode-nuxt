...
usePageSeo(
  ...
  "Configure the inner dot of the three corner finder patterns. Full API reference for the finderPatternInnerSettings prop.",
);
const styles = [
  "square",
  "pinched-square",
...
<template>
  <div class="prose">
      ...
      :rows="[
        {
          ...
          default: '\'square\'',
          description: 'Shape of the inner finder pattern dot.',
        },
        {
          name: 'color',
          type: 'string',
    ...
    <div class="callout callout-tip">
      Inner patterns support all outer styles <em>plus</em>: <code>diamond</code>, <code>star</code>,
      <code>heart</code>, <code>hashtag</code>, <code>microchip</code>.
    </div>
