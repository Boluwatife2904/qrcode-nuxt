...
<template>
  <div class="prose">
    ...
    <div class="level-grid">
      <div v-for="l in levels" :key="l" class="level-item">
        <VueQRCode :value="`Level ${l}`" :size="110" :level="l" />
        <code>level="{{ l }}"</code>
      </div>
    </div>
...
/>`"
    ...
    <DocsCodeBlock lang="vue" :code="`<QrcodeNuxt value=&quot;https://nuxt.com&quot; :size=&quot;200&quot; />`" />
  </div>
</template>
